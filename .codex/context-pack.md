...
Manual decision intake preflight: `tmp/consultant_role_kb_manual_decision_intake_preflight_20260619.py`, output `tmp/consultant-role-kb-manual-decision-intake-preflight-20260619.json`, and report `drafts/analysis/consultant-role-kb-manual-decision-intake-preflight-20260619.md`. It can validate default or externally supplied human/legal/security decision JSONL files. Current defaults are structurally valid but blocked: 0/50 human labels, 0/80 selected sources, and 0/8 security controls approved. Shared staging preflight now reads this aggregate output for manual gates.
