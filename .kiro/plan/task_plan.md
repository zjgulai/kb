...
| P6 | in_progress | Move from role-KB PoC toward full extraction, agent runtime, staging, and launch | Full extraction, durable local index, and agent launch sprint artifacts |
...
3. Whether to add human-gold eval locator labels before broader agent runtime work.
4. Whether to implement a private no-provider retrieval API as the next agent runtime slice.
